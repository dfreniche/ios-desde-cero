...
public struct PixelDrawingView: View {
    ...
    @State
    var pixelArt: PixelArt = .init(pixels: PixelArt.generatePixelArtPattern(size: PixelDrawingView.numberOfColumns),
                                   name: "Generated",
                                   dateCreation: Date(),
    ...
    public init(pixelArt: PixelArt? = nil) {
        if let pixelArt = pixelArt {
            ...
            self.pixelArt = PixelArt(pixels: PixelArt.generatePixelArtPattern(size: PixelDrawingView.numberOfColumns),
                                     name: "Generated",
                                     dateCreation: Date(),
                                     dateLastModification: Date())
        }
